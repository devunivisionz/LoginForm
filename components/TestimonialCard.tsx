...
export default function TestimonialCard({ name, subtitle, time, quote }: Testimonial) {
  return (
    <div className="bg-white rounded-xl p-6 border border-blue-100 flex flex-col h-full">
      {/* Header */}
      ...
      {/* Quote */}
      <blockquote className="text-gray-700 mt-2 text-sm leading-relaxed flex-grow">
        “{quote}”
      </blockquote>
    </div>
  )
